 ...
 * Base Class for implementing the Mapper-Operator Hides complexity from
 * students and provides helper methods
 * 
...
public abstract class MapperBase<KEYIN extends AbstractSQLValue, VALUEIN extends AbstractSQLValue, KEYOUT extends AbstractSQLValue, VALUEOUT extends AbstractSQLValue>
	...
	/**
	 * Called once for each keyValueRecord (key/value pair) in the input (split).
	 * Most applications should override this, but the default is the identity
	 * function. (This assumes KEYIN and KEYOUT/VALUEIN and VALUEOUT are of the same
	 * type)
	 */
